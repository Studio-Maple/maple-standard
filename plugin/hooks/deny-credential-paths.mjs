...
//
// No project-root-relative paths here — pattern-matches the file_path the
// tool call already carries, so it needs no maple.config.json and no cwd
// resolution. Shipped byte-for-byte from the template's own copy.
//
