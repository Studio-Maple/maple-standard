...
> **Reference for:** `maplelens-core` extraction from VeHagita's `cloudflare/error-tracker/` (external repo — extraction is #T7's sibling task; no owned paths here yet)
